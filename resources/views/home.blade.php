        ...
        <div class="col-md-8">
                ...
                <div class="row row-cols-1 row-cols-md-2 g-4 py-5">
                    ...
                    <div class="col">
                        <a href="/products" class="text-decoration-none">
                          ...
                          <div class="d-flex flex-column h-100 p-5 pb-3 text-shadow-1">
                            <h3 class="pt-5 mt-5 mb-4 display-6 lh-1 fw-bold">Products</h3>
                    ...
                    <div class="col">
                        <a href="/customers" class="text-decoration-none">
                          ...
                          <div class="d-flex flex-column h-100 p-5 pb-3 text-shadow-1">
                            <h3 class="pt-5 mt-5 mb-4 display-6 lh-1 fw-bold">Customers</h3>
                            <ul class="d-flex list-unstyled mt-auto">
                              <li class="me-auto">
            ...
            <div class="col">
                <a href="/stocks    " class="text-decoration-none text-secondary">
                  ...
                  <div class="d-flex flex-column h-100 p-5 pb-3 text-shadow-1">
                    <h3 class="pt-5 mt-5 mb-4 display-6 lh-1 fw-bold">Stocks</h3>
                    <ul class="d-flex list-unstyled mt-auto">
                      <li class="me-auto">
            ...
            {{-- Sales Card Start --}}
                    <div class="col">
                        <a href="/sales" class="text-decoration-none text-dark">
                          ...
                          <div class="d-flex flex-column h-100 p-5 pb-3 text-shadow-1">
                            <h3 class="pt-5 mt-5 mb-4 display-6 lh-1 fw-bold">Sales</h3>
                            <ul class="d-flex list-unstyled mt-auto">
                              <li class="me-auto">
